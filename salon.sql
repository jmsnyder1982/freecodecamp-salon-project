...
INSERT INTO public.appointments VALUES (1, 8, 1, 'Josh Snyder', '10am');
INSERT INTO public.appointments VALUES (7, 14, 1, 'Sara Snyder', '11am');
INSERT INTO public.appointments VALUES (13, 8, 3, ' Josh Snyder', '11am');
...
INSERT INTO public.customers VALUES ('Josh Snyder', '3862330591', 8);
INSERT INTO public.customers VALUES ('Sara Snyder', '3868017520', 14);
...
--
-- Name: services service_id_unique; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT appointments_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id) ON UPDATE CASCADE;
